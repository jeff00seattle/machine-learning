# Machine Learning Tutorial for GITW 2017
...
I suggest downloading and installing [anaconda](https://docs.continuum.io/anaconda/install/mac-os).
...
material in this tutorial by using the git address shown above:
    ...
    git clone git://github.com/jefftune/gitw-2017-ml.git
...
## Notebook Listing
You can [view the tutorial materials](http://nbviewer.ipython.org/github/jefftune/gitw-2017-ml/blob/master/notebooks/Index.ipynb) using the excellent nbviewer service.
